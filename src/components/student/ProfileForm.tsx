                ...
                <FormControl>
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      // Required field: keep undefined when empty to avoid uncontrolled/controlled flip
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    onChange={(e) => {
                      const v = e.target.value;
                      // Optional field: store undefined when empty so validation treats it as optional
                      field.onChange(v === "" ? undefined : Number(v));
                    }}
                  />
                </FormControl>
                          ...
                          <FormControl>
                            <Checkbox
                              ...
                              onCheckedChange={(checked) => {
                                return checked
                                  ? field.onChange([...(Array.isArray(field.value) ? field.value : []), item.label])
                                  : field.onChange(
